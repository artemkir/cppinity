...
TEST_CASE_METHOD(SceneTestFixture, "Canvas with TopLeft anchor and full screen", "[Canvas]") {
    ...
    auto final_trans = child_trans->GetFinalScreenTransform();
    REQUIRE(final_trans.pos.x == Catch::Approx(100.0f));
    REQUIRE(final_trans.pos.y == Catch::Approx(200.0f));
    REQUIRE(final_trans.size.x == Catch::Approx(50.0f));
    REQUIRE(final_trans.size.y == Catch::Approx(60.0f));
    REQUIRE(final_trans.pivot.x == Catch::Approx(0.0f));
    REQUIRE(final_trans.pivot.y == Catch::Approx(0.0f));
}
...
TEST_CASE_METHOD(SceneTestFixture, "Canvas with Center anchor and partial screen", "[Canvas]") {
    ...
    REQUIRE(final_trans.pos.x == Catch::Approx(400.0f));
    REQUIRE(final_trans.pos.y == Catch::Approx(300.0f));
    REQUIRE(final_trans.size.x == Catch::Approx(100.0f));
    REQUIRE(final_trans.size.y == Catch::Approx(100.0f));
    REQUIRE(final_trans.pivot.x == Catch::Approx(0.0f));
    REQUIRE(final_trans.pivot.y == Catch::Approx(0.0f));
}
...
TEST_CASE_METHOD(SceneTestFixture, "Canvas with TopLeft anchor and offset position", "[Canvas]") {
    ...
    auto final_trans = child_trans->GetFinalScreenTransform();
    REQUIRE(final_trans.pos.x == Catch::Approx(80.0f + 100.0f * 0.8f));
    REQUIRE(final_trans.pos.y == Catch::Approx(60.0f + 200.0f * 0.8f));
    REQUIRE(final_trans.size.x == Catch::Approx(50.0f * 0.8f));
    REQUIRE(final_trans.size.y == Catch::Approx(60.0f * 0.8f));
    REQUIRE(final_trans.pivot.x == Catch::Approx(0.0f));
    REQUIRE(final_trans.pivot.y == Catch::Approx(0.0f));
}
...
TEST_CASE_METHOD(SceneTestFixture, "Canvas with parent-child hierarchy and scale", "[Canvas]") {
    ...
    REQUIRE(final_trans.pos.x == Catch::Approx(175.0f));
    REQUIRE(final_trans.pos.y == Catch::Approx(175.0f));
    REQUIRE(final_trans.size.x == Catch::Approx(300.0f));
    REQUIRE(final_trans.size.y == Catch::Approx(300.0f));
    REQUIRE(final_trans.pivot.x == Catch::Approx(0.0f));
    REQUIRE(final_trans.pivot.y == Catch::Approx(0.0f));
}
...
TEST_CASE_METHOD(SceneTestFixture, "Canvas with aspect-preserving relative size", "[Canvas]") {
    ...
    auto final_trans = child_trans->GetFinalScreenTransform();
    REQUIRE(final_trans.pos.x == Catch::Approx(150.0f));
    REQUIRE(final_trans.pos.y == Catch::Approx(150.0f));
    REQUIRE(final_trans.size.x == Catch::Approx(75.0f));
    REQUIRE(final_trans.size.y == Catch::Approx(100.0f));
    REQUIRE(final_trans.pivot.x == Catch::Approx(0.0f));
    REQUIRE(final_trans.pivot.y == Catch::Approx(0.0f));
}
...
TEST_CASE_METHOD(SceneTestFixture, "Nested parent-child under Canvas with Center anchor", "[Canvas]") {
    ...
    REQUIRE(final_trans.pos.x == Catch::Approx(350.0f));
    REQUIRE(final_trans.pos.y == Catch::Approx(300.0f));
    REQUIRE(final_trans.size.x == Catch::Approx(100.0f));
    REQUIRE(final_trans.size.y == Catch::Approx(100.0f));
    REQUIRE(final_trans.pivot.x == Catch::Approx(0.0f));
...
TEST_CASE_METHOD(SceneTestFixture, "ScreenTransform with Center pivot under Canvas", "[Canvas][ScreenTransform]") {
    ...
    REQUIRE(final_trans.pos.x == Catch::Approx(150.0f));
    REQUIRE(final_trans.pos.y == Catch::Approx(340.0f));
    REQUIRE(final_trans.size.x == Catch::Approx(100.0f));
    REQUIRE(final_trans.size.y == Catch::Approx(120.0f));
    REQUIRE(final_trans.pivot.x == Catch::Approx(0.5f));
    REQUIRE(final_trans.pivot.y == Catch::Approx(0.5f));
}
...
TEST_CASE_METHOD(SceneTestFixture, "ScreenTransform with Center pivot and scale", "[Canvas][ScreenTransform]") {
    ...
    REQUIRE(final_trans.pos.x == Catch::Approx(100.0f));
    REQUIRE(final_trans.pos.y == Catch::Approx(280.0f));
    REQUIRE(final_trans.size.x == Catch::Approx(200.0f));
    REQUIRE(final_trans.size.y == Catch::Approx(240.0f));
    REQUIRE(final_trans.pivot.x == Catch::Approx(0.5f));
    REQUIRE(final_trans.pivot.y == Catch::Approx(0.5f));
}
...
TEST_CASE_METHOD(SceneTestFixture, "ScreenTransform with custom pivot and parent", "[Canvas][ScreenTransform]") {
    ...
    REQUIRE(final_trans.pos.x == Catch::Approx(25.0f));
    REQUIRE(final_trans.pos.y == Catch::Approx(25.0f));
    REQUIRE(final_trans.size.x == Catch::Approx(300.0f));
    REQUIRE(final_trans.size.y == Catch::Approx(300.0f));
    REQUIRE(final_trans.pivot.x == Catch::Approx(0.5f));
    REQUIRE(final_trans.pivot.y == Catch::Approx(0.5f));
...
TEST_CASE_METHOD(SceneTestFixture, "Canvas with GridTransform and TopLeft anchor", "[Canvas][GridTransform]") {
    ...
    REQUIRE(final_trans.pos.y == Catch::Approx(150.0f));
    REQUIRE(final_trans.size.x == Catch::Approx(50.0f));
    REQUIRE(final_trans.size.y == Catch::Approx(50.0f));
    REQUIRE(final_trans.pivot.x == Catch::Approx(0.0f));
    REQUIRE(final_trans.pivot.y == Catch::Approx(0.0f));
}
...
TEST_CASE_METHOD(SceneTestFixture, "GridTransform with Center pivot under Canvas", "[Canvas][GridTransform]") {
    ...
    // Size = (50,50)
    REQUIRE(final_trans.pos.x == Catch::Approx(75.0f));
    REQUIRE(final_trans.pos.y == Catch::Approx(125.0f));
    REQUIRE(final_trans.size.x == Catch::Approx(50.0f));
    REQUIRE(final_trans.size.y == Catch::Approx(50.0f));
    REQUIRE(final_trans.pivot.x == Catch::Approx(0.5f));
    REQUIRE(final_trans.pivot.y == Catch::Approx(0.5f));
...
TEST_CASE_METHOD(SceneTestFixture, "GridTransform under screen-centered Canvas", "[Canvas][GridTransform]") {
    ...
    auto final_trans = child_trans->GetFinalScreenTransform();
    REQUIRE(final_trans.pos.x == Catch::Approx(left_corner + x * w));
    REQUIRE(final_trans.pos.y == Catch::Approx(y * h));
    REQUIRE(final_trans.size.x == Catch::Approx(w));
    REQUIRE(final_trans.size.y == Catch::Approx(h));
}