...
public:
    ...
    Canvas(const Vector2& relative_size, const Vector2& relative_pos, const String& anchor_type, const Vector2& canvas_size);
...
private:
    ...
    String anchor_type_; // e.g., "center", "top_left"
};
